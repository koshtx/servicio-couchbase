package com.juanchogroup.serviciocouchbase;
...
public class ServicioCouchbaseApplication {
	@Bean
	...
	@Bean
	WebClient client() {
		return WebClient.create("http://localhost:8081/coffees");
	}

	public static void main(String[] args) {
		int x = 3;
		int _$$___3_$ = 3;
		SpringApplication.run(ServicioCouchbaseApplication.class, args);
	}
}
